        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Details of the registered person will show here. </p>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php $i=1; foreach($this->db->get('register')->result_array() as $value) { ?>
                  <tr>
                    <th scope="row"><?= $i ?></td>
                                <td><?= $value['Name']?></td>
                                <td><?= $value['Email']?></td>
                    ...
                    <td>
                                  <a href="<?= base_url()?>ca/customer_edit/<?= $value['Id']?>" class="btn btn-primary">Edit</a>
                                  <a href="<?= base_url()?>ca/delete_for_customers/<?= $value['Id']?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            <?php $i++; }  ?>
