    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="admin_features" class="active">
...
<div class="pagetitle">
      ...
      <a href="features_add" class="btn btn-success">+Add</a>
      </div>
      <div  style="display: flex; justify-content: space-between;">
      <nav>
        <ol class="breadcrumb">
  ...
  <a style="color: grey;" href="<?=base_url()?>ca/features_hide">
    <?php  foreach ($this->db->get('features_hide')->result_array() as  $value) { ?>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php  $i=1;
                  foreach ($this->db->get('features')->result_array() as  $value) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url()?>ca/features_edit/<?= $value['Id']?>" class="btn btn-primary">Edit</a>
                      <a href="<?= base_url()?>ca/features_delete/<?= $value['Id']?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php  $i++; }  ?>
                </tbody>
