...
<div class="pagetitle">
      ...
      <h1>Why Choose Us</h1>
      <a href="why_choose_us_add" class="btn btn-success">+Add</a>
      </div>
       <div  style="display: flex; justify-content: space-between;">
      <nav>
        <ol class="breadcrumb">
  ...
  <a style="color: grey;" href="<?=base_url()?>ca/why_choose_us_hide">
    <?php  foreach ($this->db->get('why_choose_us_hide')->result_array() as  $value) { ?>
<input class="form-check-input" type="checkbox" disabled id="flexSwitchCheckChecked" <?= $value['checkbox']?> >
   Hide/Unhide
  <?php } ?>
  </a>
</div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php  $i=1;
                  foreach ($this->db->get('why_choose_us')->result_array() as  $value) {
                
   
                   ?>
                  <tr>
                    <th scope="row"><?= $i?></th>
                    <td><img src="<?= base_url()?>image/<?= $value['image']?>" style="height: 100px; width: 100px;"></td>
                    <td><?= $value['title']?></td>
                    <td><?= $value['description']?></td>
                    <td>
                      <a href="<?= base_url()?>ca/why_choose_us_edit/<?= $value['Id']?>" class="btn btn-primary">Edit</a>
                      <a href="<?= base_url()?>ca/why_choose_us_delete/<?= $value['Id']?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php  $i++; }  ?>
                </tbody>
