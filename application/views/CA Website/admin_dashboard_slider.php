...
?>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="admin_dashboard_slider" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <h1>Slider</h1>
      <a href="slider_add" class="btn btn-success">+Add</a>
      </div>
      <nav>
        <ol class="breadcrumb">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url()?>ca/slider_edit/<?= $value['Id']?>" class="btn btn-primary">Edit</a>
                      <a href="<?= base_url()?>ca/slider_delete/<?= $value['Id']?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php  $i++; }  ?>
                </tbody>
