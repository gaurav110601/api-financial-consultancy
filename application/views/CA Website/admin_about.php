...
<div class="pagetitle">
      ...
      <h1>About Us</h1>
      <a href="about_add" class="btn btn-success">+Add</a>
      </div>
      <div  style="display: flex; justify-content: space-between;">
      <nav>
        <ol class="breadcrumb">
  ...
  <a style="color: grey;" href="<?=base_url()?>ca/about_hide">
    <?php  foreach ($this->db->get('about_hide')->result_array() as  $value) { ?>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php  $i=1;
                  foreach ($this->db->get('about')->result_array() as  $value) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url()?>ca/about_edit/<?= $value['Id']?>" class="btn btn-primary">Edit</a>
                      <a href="<?= base_url()?>ca/about_delete/<?= $value['Id']?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php  $i++; }  ?>
                </tbody>
