...
<div class="pagetitle">
  ...
  <a style="color: grey;" href="<?=base_url()?>ca/header_hide">
    <?php  foreach ($this->db->get('header_hide')->result_array() as  $value) { ?>
            ...
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <th scope="row"><?= $i?></th>
                    <td><img src="<?= base_url()?>image/<?= $value['image']?>" style="height: 100px; width: 200px;"></td>
                    <td><?= $value['contact_no']?></td>
                    <td>
                      <a href="<?= base_url()?>ca/header_edit/<?= $value['Id']?>" class="btn btn-primary">Edit</a>
                    </td>
                  </tr>
                  <?php  $i++; }  ?>
                </tbody>
