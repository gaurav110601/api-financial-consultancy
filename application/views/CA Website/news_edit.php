            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                 <!-- <img src="assets/img/logo.png" alt=""> -->
                  <center><span class="d-none d-lg-block"> Edit data to <br> "Latest News" Section</span></center>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 " method="post" action="<?= base_url() ?>Ca/news_edit/<?= $user->Id ?>"  enctype="multipart/form-data">
