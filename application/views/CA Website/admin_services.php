...
<div class="pagetitle">
      ...
      <h1>Our Services</h1>
      <a href="services_add" class="btn btn-success">+Add</a>
      </div>
      <div  style="display: flex; justify-content: space-between;">
      <nav>
        <ol class="breadcrumb">
  ...
  <a style="color: grey;" href="<?=base_url()?>ca/services_hide">
    <?php  foreach ($this->db->get('services_hide')->result_array() as  $value) { ?>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php  $i=1;
                  foreach ($this->db->get('services')->result_array() as  $value) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url()?>ca/services_edit/<?= $value['Id']?>" class="btn btn-primary">Edit</a>
                      <a href="<?= base_url()?>ca/services_delete/<?= $value['Id']?>" class="btn btn-danger">Delete</a>
                    </td>
                  </tr>
                  <?php  $i++; }  ?>
                </tbody>
